...
public class Appv1Activity extends Activity {
	...
	private static final String TAG = "AppV1";

	Loader1 loader;
	ActivityDelegate4 delegate;

	public Appv1Activity() {
		StarterActivity.log("Appv1Activity instantiated");
		loader = StarterActivity.getLoaderInstance();
		
		delegate = loader.createActivityDelegate4(this, new Super(this), R.layout.app);
	}
